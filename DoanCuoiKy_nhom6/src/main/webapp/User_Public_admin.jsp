...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li><a href="widgets_admin.html"><em class="fa fa-calendar">&nbsp;</em> Quản Lý</a></li>
            ...
            <li><a href="panels_admin.html"><em class="fa fa-clone">&nbsp;</em> Cảnh Báo</a></li>
            ...
            <li v class="parent "><a class="active" data-toggle="collapse" href="#sub-item-1">
                ...
                <ul class="children collapse" id="sub-item-1">
                    <li><a class="" href="Administrators.html">
                        <span class="">&nbsp;</span> Quản Trị Viên
                    </a></li>
                    <li class="active"><a class="active" href="User_Public_admin.html">
                ...
                <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                    <div class="panel panel-teal panel-widget border-right">
                        <div class="row no-padding"><em class="fa fa-xl fa-users color-blue"></em>
                            ...
                            <div class="text-muted">Tổng Số Người Dùng</div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                    ...
                    <div class="table-a">
                        <table class="table-user">
                            <%
                                ...
                                List<Account_User> cList = (List<Account_User>) request.getAttribute("listCart");
                                int sum = (int) request.getAttribute("sum");
                                for (Account_User p : cList) {
                            %>
                            <thead>
                                <tr class="boder-t">
                                    <th class="row-1">
                                    ...
                                    <th class="row-7" >Mã người dùng</th>
                                    <th class="row-2 row-cols-2"> Tên</th>
                                    <th class="row-3 row-cols-3"> Email</th>
                                    <th class="row-4 row-cols-4">Số điện thoại</th>
                                    <th class="row-5 row-cols-5">Ngày đăng ký</th>
                                    <th class="row-6 row-cols-6">Lịch sử mua sắm</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="boder-t" id="<%=p.getMaKH()%>">
                                    <th class="row-1">
                                        <input type="checkbox">
                                    </th>
                                    <td><%=p.getMaKH()%></td>
                                    <td><a><%=p.getTenKH()%></a></td>
                                    <td><%=p.getEmail()%></td>
                                    <td><%=p.getSDT()%></td>
                                    <td><%=p.getNgayDK()%></td>
