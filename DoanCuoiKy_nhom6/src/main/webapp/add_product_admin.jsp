...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li class="parent-1 "><a data-toggle="collapse" href="#sub-item-2">
            <em class="fa fa-list">&nbsp;</em> Quản Lý Danh Mục <span data-toggle="collapse" href="#sub-item-2"
                                                                      class="icon pull-right"><em
                class="fa fa-list-alt"></em></span>
        </a>
        ...
        <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
            <em class="fa fa-user-circle">&nbsp;</em> Thành Viên <span data-toggle="collapse" href="#sub-item-1"
                                                                       class="icon pull-right"><em
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="add">
        <button id="button-themsp">Thêm sản phẩm</button>
    </div>
    <div class="container1">
        <form action="${project}/admin-add-product" method="POST" id="form-add" enctype="multipart/form-data">
            <div class="tilteproduct">
                <div class="form-1">
                    <fieldset>
                        <legend>Tiêu đề</legend>
                        Tên sản phẩm*: <br>
                        <input class="addProduct" name="tensp"><br><br>
                        Danh mục cha: <br>
                        <select name="danhmuc">
                            <option>--không--</option>
                            <option value="DM02" name="tom">Tôm</option>
                            <option value="DM03" name="cua">Cua</option>
                            <option value="DM01" name="ca">Cá</option>
                        </select>
                    </fieldset>
                </div>
            </div>
            <div class="tilteproduct">
                <div class="form-1">
                    <fieldset>
                        ...
                        Giá bán sản phẩm*:
                        <input class="addInfo-1 addInfo" name="giaban"><br><br>
                        Giá khuyến mãi:
                        <input class="addInfo-2 addInfo" name="giakhuyenmai"> <br><br>
                        Ảnh chính sả phẩm*
                        <input type="file" id="imageUploadInput" name="img"><br>

                        Xuất sứ :
                        <input class="addInfo-3 addInfo" name="xuatsu"><br><br>
                        Tình trạng kho hàng*:
                        ...
                        <input type="checkbox"> Sản phẩm nổi bật <br><br>
            ...
            <div class="tilteproduct">
                ...
                <div class="form-1">
                    <fieldset>
                        ...
                        <div class="textarea">
                            <textarea class="text" name="motasp"></textarea>
                        </div>
                    </fieldset>
                </div>
            </div>
...
<script>
    $('#button-themsp').on('click', function () {
        $("#form-add").submit()
    })
</script>
</body>
