				...
				<div class="header-right w3agile">
					...
					<div class="header-left-bottom agileinfo">
					 ...
					 <form action="#" method="post">
                        ...
                        <input type="tel"  value="Số Điện Thoại" name="Số Điện Thoại" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Số Điện Thoại';}"/>
                    ...
                    <form action="login.html">
                        <input type="submit" value="Đăng Ký" src="login.html">
                    </form>
				</div>
				</div>
