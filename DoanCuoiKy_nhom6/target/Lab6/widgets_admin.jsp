...
<!--							</a></li>-->
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="widgets_admin.jsp"><em class="fa fa-calendar">&nbsp;</em> Quản Lý</a></li>
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
				<em class="fa fa-user-circle">&nbsp;</em> Multilevel <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
...
<!--						</div>&lt;!&ndash;End .article&ndash;&gt;-->
					...
					<div class="panel-body">
						<div class="col-md-12 no-padding">
							<div class="row progress-labels">
								<div class="col-sm-6">Đơn hàng mới</div>
							...
							<div class="row progress-labels">
								<div class="col-sm-6">Bình luận</div>
							...
							<div class="row progress-labels">
								<div class="col-sm-6">Người dùng mới</div>
							...
							<div class="row progress-labels">
								<div class="col-sm-6">Trang mới</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						Chương trình đặt biệt trong tháng
						<ul class="pull-right panel-settings panel-button-tab-right">
							<li class="dropdown"><a class="pull-right dropdown-toggle" data-toggle="dropdown" href="#">
								<em class="fa fa-cogs"></em>
							</a>
...
<!--						</ul>-->
					...
					<div class="panel-footer">
						<div class="input-group">
							<input id="btn-input-1" type="text" class="form-control input-md" placeholder="Add new task" /><span class="input-group-btn">
