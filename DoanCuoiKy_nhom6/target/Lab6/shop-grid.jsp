            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        ...
                        <div class="header__top__right__auth">
                            <a href="./login_home.html"><i class="fa fa-user"></i> Đăng nhập</a>
                        </div>
                    </div>
                </div>
            </div>
...
<%--                                </a>--%>
                ...
                <div class="col-lg-9 col-md-7">
                    <div class="product__discount">
                        ...
                        <div class="row">
                            <% List<Product> list3= (List<Product>) request.getAttribute("list");
                                for (Product p:list3) {  %>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="product__discount__item">
                                            ...
                                            <div class="product__discount__item__text">
                                                ...
                                                <div class="product__item__price"><%= p.getPrice()%>đ<span><%= p.getPrice()%>đ</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <% List<Product> list4= (List<Product>) request.getAttribute("list");
                                for (Product p:list4) {  %>
