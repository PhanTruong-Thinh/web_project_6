...
<!--							</a></li>-->
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="admin.jsp"><em class="fa fa-dashboard">&nbsp;</em> Bảng Điều Khiển</a></li>
...
<!--						</ul>-->
					...
					<div class="panel-footer">
						<div class="input-group">
							<input type="text" class="form-control input-md" placeholder="Nhập tin nhắn..." /><span class="input-group-btn">
					...
					<div class="table-a">
						<table class="table-user">
							<tr class="boder-t">
								...
								<th class="row-4 row-cols-4">Chi tiêu</th>
							</tr>
							<tr class="boder-t">
								<th class="row-1">1</th>
								<td>US002</td>
								<td><a>Phan Trường Thịnh</a></td>
