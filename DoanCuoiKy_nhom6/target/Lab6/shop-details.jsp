                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li class="active"><a href="./shop-grid.html">Mua sắm</a></li>
                            <!-- <li><a href="#">Pages</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="./shop-details.jsp">Shop Details</a></li>
                                    <li><a href="./shoping-cart.html">Shoping Cart</a></li>
                ...
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Mực</a></li>
                            <li><a href="#">Hàu</a></li>
                            <li><a href="#">Nghêu</a></li>
                            <li><a href="#">Các loại đồ biển</a></li>
                            <li><a href="#">Chưa biết</a></li>
                            <li><a href="#">Chưa nghĩ ra</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-9">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">1.400.000</div>
                        <p>Tôm hùm Alaska, hay còn gọi là tôm hùm Canada là giống tôm tùm thường được tìm thấy ở khu vực biển Alaska của Bắc Mỹ. Loài tôm hùm này thường có tốc độ sinh sản lớn và tốc độ phát triển nhanh.
                            Nhờ đặc tính sinh sống và hoạt động ở vùng biển lạnh, tối nên lớp vỏ của loài tôm hùm Alaska rất chắc chắn, phần thịt dày, đầy đặn và ngọt đã khiến loại tôm này luôn nằm trong thực đơn của các nhà hàng cao cấp.</p>
                        ...
                        <ul>
                            ...
                            <li><b>Giao hàng</b> <span>Giao hàng trong 3h.</span></li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="product__details__tab__desc">
                                    <h6>Mô tả</h6>
                                    <p>Tôm hùm Alaska còn gọi là tôm hùm Canada, tôm hùm Mỹ,
                                    được đánh bắt tự nhiên tại vùng biển Alaska phía tây bắc nước Mỹ, 
                                    là loài tôm càng có thân hình lực lưỡng. Loài tôm này sống ở các 
                                    bãi đá ngầm nước trong xanh cực lạnh nên thịt có màu trắng, dai, 
                                    vị ngọt đậm đà và thơm hơn tôm nuôi.</p>
                                </div>
                            </div>
                            <div class="tab-pane active" id="tabs-2" role="tabpanel">
                                <div class="product__details__tab__desc">
                                    <h6>Thông tin sản phẩm</h6>
                                    <p>Tôm hùm Alaska còn gọi là tôm hùm Canada, tôm hùm Mỹ, được đánh bắt tự nhiên tại vùng biển Alaska phía tây bắc nước Mỹ, là loài tôm càng có thân hình lực lưỡng. Loài tôm này sống ở các bãi đá ngầm nước trong xanh cực lạnh nên thịt có màu trắng, dai, vị ngọt đậm đà và thơm hơn tôm nuôi.Thịt tôm hùm Alaska chứa nhiều khoáng chất, vitamin có lợi cho sự duy trì và phát triển các tế bào thần kinh, giúp xương chắc khỏe. Ngư dân Mỹ và Canada đánh bắt tôm hùm Alaska theo cách thủ công. Ngay khi kéo lên bờ, tôm được giữ trong các thùng nước biển và chuyển đi khắp thế giới để giữ trọn vẹn sự tươi ngon, tinh khiết. Đây được xem là món ăn bổ dưỡng bởi tôm được đánh bắt tự nhiên, chất lượng thịt cao</p>
                                    <p>Gạch son ở đầu tôm có vị béo ngậy bùi hơn nhiều so với gạch cua và râu tôm. Hàm lượng protein, vitamin, canxi dồi dào trong tôm hùm bổ sung cho cơ thể hỗ trợ phòng ngừa các bệnh cao huyết áp, tim mạch và tăng cường sinh lực ở nam giới.
                                        Axit béo Omega3 có trong tôm hùm tác dụng kìm hãm và giảm nguy cơ mắc các bệnh tim mạch.
                                        Tôm hùm cũng là nguồn bổ sung vitamin B12 (Cobalamin) hiệu quả cho cơ thể. Đây là loại vitamin phức tạp nhất tham gia vào quá trình sinh hóa và chuyển hóa năng lượng trong cơ thể con người, giữ vai trò quan trọng trong tổng hợp nucleotic, protein. Cơ thể thiếu hụt vitamin B12 có thể dẫn đến mệt mỏi, chóng mặt, cơ bắp yếu ớt, trường hợp nặng hơn sẽ bị tổn hại thần kinh, dễ mắc các bệnh thiếu máu và mất trí.</p>
                                </div>
                            </div>
                            <div class="tab-pane active" id="tabs-3" role="tabpanel">
                                <div class="product__details__tab__desc">
                                    <h6>Đánh giá khách hàng</h6>
                                    <p>Tôm hùm Alaska cho chất lượng thịt thơm ngon. Đặc biệt, tôm hùm càng trưởng thành, thịt tôm lại càng săn chắc. Các thớ thịt rõ ràng và tạo thành các khối dai giòn chắc chắn. Thịt tôm alaska rất giàu đạm và canxi và bổ sung các khoáng chất thích hợp cho trẻ em và người lớn tuổi.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            <h6><a href="#">Cua hoàng đế</a></h6>
                            <h5>2.000.000đ/1kg</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
