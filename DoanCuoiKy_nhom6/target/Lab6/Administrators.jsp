    ...
    <ul class="nav menu">
      ...
      <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
        ...
        <ul class="children collapse" id="sub-item-1">
          <li class="active"><a class="active" href="Administrators.jsp">
      ...
      <li><a href="login_admin.jsp"><em class="fa fa-power-off">&nbsp;</em> Đăng Xuất</a></li>
    </ul>
  </div><!--/.sidebar-->
              ...
              <table class="table-user">
                <thead>
                  <tr class="boder-t">
                    ...
                    <th class="row-2 row-cols-2"> Tên đăng nhập</th>
               ...
               <tbody>
                 <tr class="boder-t">
                   ...
                   <td><a>Phan Thịnh</a></td>
                   <td>Phan Trường Thịnh</td>
